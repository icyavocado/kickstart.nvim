...
vim.api.nvim_set_hl(0, 'TrailingWhitespace', { bg = colors.red })
...
vim.api.nvim_create_autocmd('InsertLeave', {
  callback = function()
    vim.opt.listchars.trail = space_dot
    vim.api.nvim_set_hl(0, 'TrailingWhitespace', { bg = colors.red })
  end,
})
...
-- Tab indentation
local tab_opts = { silent = true, noremap = true }
vim.keymap.set('n', '<Tab>', '>>', tab_opts)
    ...
    config = function()
      ...
      cmp.setup {
        ...
        mapping = cmp.mapping.preset.insert {
          ...
          ['<S-h>'] = cmp.mapping.select_next_item(),
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      require('nvim-treesitter.configs').setup {
        ensure_installed = { 'bash', 'c', 'html', 'lua', 'markdown', 'vim', 'vimdoc', 'perl', 'css', 'scss', 'javascript' },
